...
import com.cn.ge.dto.RoleDto;
import com.cn.ge.dto.UserDto;
import com.cn.ge.service.RoleService;
import com.cn.ge.service.UserService;
...
public class UserAction extends BaseAction {
	...
	public String showAddUserAction() {
		try {
			this.clearMessages();
			addUserDto = new UserDto();
			addUserDto.setRolecode(Constants.ROLE_CODE_NORMAL);
	...
	public String addUserAction() {
		try {
			...
			addUserDto.setUpdateuser(username);
			addUserDto.setCreateuser(username);
	...
	public String updUserAction() {
		try {
			...
			//修改
			String username = (String) ActionContext.getContext().getSession().get(Constants.SESSION_USER_NAME);
			updUserDto.setUpdateuser(username);
