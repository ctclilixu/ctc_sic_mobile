...
<script type="text/javascript">
	...
	//查询数据
	function queryList() {
		document.mainform.action = '../user/queryUserAction.action';
		document.mainform.submit();
	}
	...
	function changePage(pageNum) {
		...
		document.mainform.action = '../user/turnUserAction.action';
		document.mainform.submit();
	}
	...
	<div id="containermain">
		<div class="content">
			...
			<s:form id="mainform" name="mainform" method="POST">
				...
				<div class="searchbox">
					<div class="box1">
						<label class="pdf10" style="width:80px">用户名</label>
						<div class="box1_left"></div>
						<div class="box1_center">
							<s:textfield name="queryUsername" id="queryUsername" cssStyle="width:235px;" maxlength="16" theme="simple"></s:textfield>
						</div>
						...
						<table class="info_tab" width="100%" border="1" cellpadding="5" cellspacing="0">
							...
							<s:iterator id="userList" value="userList" status="st1">
								...
								<s:else>
									...
									<td>
										<s:iterator id="showRoleDtoList" value="showRoleDtoList" status="st3">
											<s:if test="%{showRoleDtoList[#st3.index].rolecode == userList[#st1.index].rolecode}">
