								...
								<div class="box1_center">
									<select name="addUserDto.rolecode" id="rolecode" style="width: 300px;">
										...
										<s:iterator value="showRoleDtoList" id="showRoleDtoList" status="st1">
											<option value="<s:property value="rolecode"/>" <s:if test="%{showRoleDtoList[#st1.index].rolecode == addUserDto.rolecode}">selected</s:if>><s:property value="rolename"/></option>
										</s:iterator>
									</select>
								</div>
								<div class="box1_right"></div>
