...
<frameset rows="80,*">
	...
	<frameset cols="182,7,*" id="info_frame">
		...
		-->
		<frame src="<%=request.getContextPath()%>/doc/showUploadDocAction.action" frameborder="0" scrolling="auto" marginwidth="0" marginheight="0" name="mainFrame" id="mainFrame" title="mainFrame" />
	</frameset>
</frameset>
</html>
